...
public class SuaChonMonActivity extends AppCompatActivity {
    ...
    String urlUpdate = " http://192.168.1.11/food-menu-vhnhan/json/datmon/update.php";
    String urlgetData_BanAn = "http://192.168.1.11/food-menu-vhnhan/json/banan/getdata.php";
