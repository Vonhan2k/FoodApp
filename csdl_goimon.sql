...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 14, 2022 lúc 02:31 PM
...
INSERT INTO `tbl_datmon` (`id`, `monan_id`, `dongia`, `soluong`, `thanhtien`) VALUES
(98, 1, 20000, 4, 80000),
(99, 2, 25000, 4, 100000);
...
(10, 'Canh bóng mọc thập cẩm', 60000, 'canh_bong.png', 1),
...
(15, 'Cua biển rang me chua ngọt', 5000, 'cua_bien_rang_me_chua_ngot.png', 4),
...
(62, 'Com Trang', 10000, 'img1994038586.jpg', 1),
(70, 'chao dinh duong', 10000, 'img1248883693.jpg', 1),
(72, 'chao dinh duong', 12000, 'img858076843.jpg', 1),
(78, 'com 11', 15999, 'img1247146314.jpg', 1);
...
(1, 'vonhan2k', '123456', 'Võ Hữu Nhân', 0, '0000-00-00', 1),
(2, 'thaingoc2k', 'admin', 'Thái Ngọc', 0, '0000-00-00', 0);
...
--
ALTER TABLE `tbl_monan`
  MODIFY `mamon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
-- Các ràng buộc cho bảng `tbl_datmon`
--
ALTER TABLE `tbl_datmon`
  ADD CONSTRAINT `tbl_datmon_ibfk_1` FOREIGN KEY (`monan_id`) REFERENCES `tbl_monan` (`mamon`) ON UPDATE CASCADE;
COMMIT;
